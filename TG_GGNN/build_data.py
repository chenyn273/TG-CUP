...
def get_code_change_seq(old_method, new_method):
    ...
    # results = processor.preprocess_desc(old_method, new_method)
    # diffs = []
    # for i in range(len(results)):
    #     diffs.append(construct_diff_sequence(results[i]['src_sent_tokens'], results[i]['dst_sent_tokens']))
...
# get_code_change_seq('Save basic clusters.', 'Save cluster basic configuration.')
