...
def beam_search(model, src, src_mask, node_values, node_len, node_as_output, edge_pret2ch, edge_prev2next,
                edge_align, edge_com2sub, max_len, pad, bos, eos, beam_size, device):
    ...
    def beam_decode_step(
        ...
        word_logprob = predict_word(dec_seq, enc_output, node_state, n_active_inst, n_bm)
    ...
    with torch.no_grad():
        ...
        for len_dec_seq in range(1, max_len + 1):
            ...
            active_inst_idx_list = beam_decode_step(
                inst_dec_beams, len_dec_seq, src_enc, node_state, inst_idx_to_position_map, beam_size)
