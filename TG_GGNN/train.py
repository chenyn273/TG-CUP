    ...
    with torch.no_grad():
        ...
        for batch in tqdm(data):
            ...
            if use_beam:
                ...
                decode_result = batch_greedy_decode(model, src, src_mask, batch.node_value, batch.node_len,
                                                    batch.node_as_output, batch.edge_prt2ch, batch.edge_prev2next,
                                                    batch.edge_align, batch.edge_com2sub,
